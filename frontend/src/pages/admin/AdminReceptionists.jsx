...
const AdminReceptionists = () => {
  ...
  const fetchReceptionists = async () => {
    try {
      const { data } = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/admin/receptionists`)
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true)
    try {
      const { data } = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/admin/receptionists`, formData)
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const { data } = await axios.delete(`${import.meta.env.VITE_BACKEND_URL}/api/admin/receptionists/${id}`)
      toast.success(data.message)
      fetchReceptionists()
    } catch (error) {
